...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        ClubData.add(new Club("Ростов", "Горького"));
        ClubData.add(new Club("Москва", "Сладкого"));
        ClubData.add(new Club("Брянск", "Солёного"));
        ClubData.add(new Club("Иркутск", "Революции"));
